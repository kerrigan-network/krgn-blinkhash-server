...
// Kerrigan KawPoW Configuration File
// Multi-algo coin: this config handles KawPoW only
...
const config = {};
config.enabled = true;
config.name = 'Pool-Kerrigan-KawPoW';
...
ports1.difficulty.minimum = 0.01;
ports1.difficulty.maximum = 2048;
...
// Mining algo is kawpow, but block hash is always x11
