...
// Kerrigan X11 Configuration File
// Multi-algo coin: this config handles X11 only
...
ports1.tls = false;
ports1.difficulty = {};
ports1.difficulty.initial = 0.01;
ports1.difficulty.minimum = 0.001;
...
// Block hash is always x11 regardless of mining algo
